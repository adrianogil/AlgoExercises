...
class AutomataMaze:
        ...
        while current_t < max_t:
            ...
            for pos in current_pos_list:
                for mov in possible_movements:
                    ...
                    if self.is_valid_pos(next_pos, pos["path"], next_pos_list, pos["life"]):
                        next_pos_data = {
                            "pos": next_pos,
                        ...
                        if pos["life"] > 0 and self.next_maze_state[next_pos[1], next_pos[0]] == LIVE_CELL:
                            next_pos_data["life"] = pos["life"] - 1
                        else:
                            next_pos_data["life"] = pos["life"]
    ...
    def is_valid_pos(self, pos, path, next_pos_list, life):
        return pos[0] >= 0 and pos[0] < self.size_x and \
               pos[1] >= 0 and pos[1] < self.size_y and \
               (self.next_maze_state[pos[1], pos[0]] == DEAD_CELL or (life > 0 and self.next_maze_state[pos[1], pos[0]] == LIVE_CELL)) and \
